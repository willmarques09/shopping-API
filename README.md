...
### DOC => https://documenter.getpostman.com/view/20351136/VUjMnkSv
...
```bash
git clone git@github.com:willmarques09/shopping-API.git
```

ou

```bash
git clone https://github.com/willmarques09/shopping-API.git
```
